...
public class TwoItemToThreeItemRecipeCategory<R extends RebornRecipe> extends AbstractRebornEnergyRecipeCategory<R> {
	...
	public TwoItemToThreeItemRecipeCategory(IRecipeHolderType<R> recipeType) {
		super(recipeType);
	}

	public TwoItemToThreeItemRecipeCategory(IRecipeHolderType<R> recipeType, Component title) {
