...
public class TwoItemToFourItemCircleRecipeCategory<R extends RebornRecipe> extends AbstractRebornEnergyRecipeCategory<R> {
	...
	public TwoItemToFourItemCircleRecipeCategory(IRecipeHolderType<R> recipeType) {
		super(recipeType);
	}

	public TwoItemToFourItemCircleRecipeCategory(IRecipeHolderType<R> recipeType, Component title) {
