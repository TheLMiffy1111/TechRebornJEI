...
public class GuiRenderUtil {
	...
	public static void blitSprite(PoseStack poseStack, TextureAtlasSprite sprite, float x, float y, float uOffset, float vOffset, int textureWidth, int textureHeight) {
