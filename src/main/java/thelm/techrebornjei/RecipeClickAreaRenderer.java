...
public record RecipeClickAreaRenderer(GuiBase<?> guiBase, int x, int y) implements Widget {

	@Override
	public void render(PoseStack poseStack, int mouseX, int mouseY, float partialTick) {
		guiBase.builder.drawJEIButton(poseStack, guiBase, x, y, GuiBase.Layer.BACKGROUND);
	}
